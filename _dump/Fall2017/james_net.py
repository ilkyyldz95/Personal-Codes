...
# Load Images
    ...
    #concat_abs_net.load_weights("epochs/JAMES_F_"+str(learningRate)+"_epoch150_32_F_inputAll_" + str(kthFold) + ".h5", by_name=True)
    ...
    # Save weights for F
    concat_abs_net.save("epochs/JAMES_F_"+str(learningRate)+"_epoch100_" + str(kthFold) + ".h5")
