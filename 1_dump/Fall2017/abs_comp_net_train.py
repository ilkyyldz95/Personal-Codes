...
# Save weights for F
abs_net_1.save("abs_comp_train_absnet_" + str(data_size_comp) + '_' + str(alpha) + ".h5")
comp_net.save("abs_comp_train_compnet_" + str(data_size_comp) + '_' + str(alpha) + ".h5") #test with this!