...
def create_googlenet(no_classes=1, no_features=None):
    ...
    conv1_7x7_s2 = Conv2D(64, (7, 7), name="conv1/7x7_s2", activation="relu", padding="same", strides=(2, 2), kernel_regularizer=l2(0.0002))(input)
    ...
    loss1_classifier = Dense(no_classes, name='loss1/classifier', kernel_regularizer=l2(0.0002))(loss1_drop_fc)
    ...
    loss2_classifier = Dense(no_classes, name='loss2/classifier', kernel_regularizer=l2(0.0002))(loss2_drop_fc)
    ...
    if type(no_features) is int and no_features != 1024:
        loss3_features = Dense(no_features, name='loss3/features', kernel_regularizer=l2(0.0002))(loss3_flat)
    else:
        loss3_features = loss3_flat

    pool5_drop_7x7_s1 = Dropout(0.4,name='dropout')(loss3_features)

    if no_classes > 2:
        print("softmax activation")
        loss3_classifier = Dense(no_classes, name='loss3/classifier_modified', kernel_regularizer=l2(0.0002))(pool5_drop_7x7_s1)
        loss3_classifier_act = Activation('softmax', name='prob_modified')(loss3_classifier)
    else:
        print("sigmoid activation")
        loss3_classifier = Dense(1, name='loss3/classifier_modified', kernel_regularizer=l2(0.0002))(pool5_drop_7x7_s1)
